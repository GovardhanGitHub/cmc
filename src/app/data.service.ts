...
export class DataService {
  ...
  private url = 'https://clin.cmcvellore.ac.in/newconference/ConferencePay.asmx';
prod_cred  = {
  userName : 'UMRCETS',
  password : 'us8FaGH5',
  program : 'TSURCME',
  ...
  private test_url = 'https://clin.cmcvellore.ac.in/TestConference/ConferencePay.asmx';
  test_cred  = {
    userName : 'UMRESTC',
    password : 'zEVjHc9Y',
    program : 'TSURCME',
 ...
 sendSOAPRequest(formData: any): Observable<any> {
  ...
  return this.httpClient.post(this.test_url, soapBody, { headers, responseType: 'text' });
}
